...
exports.Blowfish = function (key, mode) {
    this.key = key;
    if (mode === "ecb" || mode === "cbc")
        this.mode = mode;
    this.sBox0 = exports.Blowfish.sBox0.slice();
    this.sBox1 = exports.Blowfish.sBox1.slice();
    this.sBox2 = exports.Blowfish.sBox2.slice();
    this.sBox3 = exports.Blowfish.sBox3.slice();
    this.pArray = exports.Blowfish.pArray.slice();
    this.generateSubkeys(key);
};
exports.Blowfish.prototype = {
    sBox0: null,
    sBox1: null,
    sBox2: null,
    sBox3: null,
    ...
    decrypt: function (data, iv) {
        if (this.mode === "ecb")
            return this.decryptECB(data);
        if (this.mode === "cbc")
            return this.decryptCBC(data, iv);
        throw new Error("BF: unknown cipher mode");
    },
    encryptECB: function (data) {
        ...
        for (var i = 0; i < blocks; i++) {
            ...
            if (block.length < 8)
                throw new Error('BF: data length not multiple of 8');
            var xL, xR;
            ...
            if (data instanceof Uint8Array) {
                ...
                encrypted = encrypted.concat(this.num2block32(xL), this.num2block32(xR));
        }
        if (!(data instanceof Uint8Array))
            return encrypted;
    },
    ...
    decryptECB: function (data) {
        ...
        for (var i = 0; i < blocks; i++) {
            var block = data.slice(i * 8, (i + 1) * 8);
            if (block.length < 8)
                throw new Error('BF: ciphertext too short (must be multiple of 8 bytes)');
            var xL, xR, xLxR;
            xLxR = this.split64by32(block);
            xL = xLxR[0];
            xR = xLxR[1];
            ...
            if (data instanceof Uint8Array) {
                ...
                decrypted = decrypted.concat(this.num2block32(xL), this.num2block32(xR));
        }
        if (!(data instanceof Uint8Array))
            return decrypted;
    },
