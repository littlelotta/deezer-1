...
exports.AES = function (key) {
    if (!(this instanceof exports.AES)) {
        throw Error('AES must be instanitated with `new`');
    }
    this.key = createBuffer(key);
    this._prepare();
};
exports.AES.prototype._prepare = function () {
...
exports.AES.prototype.encrypt = function (plaintext) {
...
exports.AES.prototype.decrypt = function (ciphertext) {
...
exports.Counter = function (initialValue) {
    if (!(this instanceof exports.Counter)) {
...
exports.Counter.prototype.setValue = function (value) {
...
exports.Counter.prototype.setBytes = function (bytes) {
    if (bytes.length != 16) {
...
var ModeOfOperationCTR = function (key, counter) {
    ...
    if (!(counter instanceof exports.Counter)) {
        counter = new exports.Counter(counter);
    }
